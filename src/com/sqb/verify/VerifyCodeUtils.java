...
public class VerifyCodeUtils {
    ...
    public final static String VERIFY_CODES = "123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    ...
    private static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            g2.drawLine(x1, y1, x + x1 + 40, y + y1 + 20);
        }
